				  	...
				  	<div className="row">
				  		<div className="col-md-2">
							<div className="projectpane" > 
								<img src="images/plannericon.png" alt="Planner" className="image img-fluid" />
							  	<div className="overlay">
							    	<div className="text">
							    		<h1> Planner </h1>
							    		<p style={{fontSize: 13}}> A Java desktop app to help students organize their life </p>
							    		<button className="btn btn-primary learnmore" onclick="createProjectInfoBox(this, 'Planner')"> Learn More </button>
							    	</div>
							 	 </div>
							</div>
						</div>
								...
								<img src="images/MyAppLogo.png" alt="Classics" className="image img-fluid" />
							  	<div className="overlay">
							    	<div className="text">
							    		...
							    		<button className="btn btn-primary learnmore" onclick="createProjectInfoBox(this, 'Classics')"> Learn More </button>
							    	</div>
							 	 </div>
							</div>
						</div>
